...
"這就是所謂的神之操作嗎？"
        ...
        science: [
            ...
            "打噴嚏的速度可以超過時速160公里。",
            "人的大腦在晚上的活動比白天還活躍。",
            "你知道嗎？鑽石其實是可以燃燒的。",// --- 社畜上帝篇 ---
"其實我的正職是寫 code，創世只是兼職。",
"你以為我是全能的？我連下個月房租都煩惱。",
"演化失敗沒關係，反正我也沒預算重做。",
"這世界充滿了 bug，但我懶得修。",
"你有沒有覺得那隻恐龍長得像不想上班的我？",
"別吵，我正在跟隔壁棚的宙斯打麻將。",
"人類的脊椎設計不良真的不是我的錯，是外包廠商的問題。",
"為什麼一天只有24小時？因為我當時算錯了。",
"我把幸運點數都加在蟑螂身上了，抱歉。",
"好想離職... 阿不對，我是老闆。",
"週一症候群這種東西，連神都逃不掉。",
"你慢慢玩，我去泡碗泡麵。",
...
"嘿，不要用那種眼神看我，我只是一張圖片。",
"你玩遊戲都不開聲音的嗎？我的配樂很讚耶。",
"其實你是被關在手機裡，我是在外面看你的人。",
"這個滑動的手感... 嗯，有練過喔。",
"我覺得你的手機電量在求救。",
"如果遊戲當機，絕對不是我的問題，是你的手機累了。",
"你知道嗎？這個對話框其實是用愛發電的。",
"再滑快一點！我快跟不上了！",
"你相信我是 AI 寫出來的嗎？還是我是真的神？",

// --- 奇怪的演化吐槽篇 ---
"蚊子？那是為了測試人類脾氣而設計的。",
"鴨嘴獸是我喝醉時隨便拼湊出來的。",
"為什麼貓咪這麼可愛？因為我私心。",
"長頸鹿的脖子那麼長，是因為它想偷看別人的考卷。",
"恐龍滅絕是因為牠們手太短，沒辦法按讚。",
"人類為什麼要長智齒？大概是為了讓牙醫賺錢吧。",
"我本來想給人類翅膀的，但怕你們亂飛撞到衛星。",
"熊貓其實是黑白的，因為當時彩色墨水用完了。",
"斑馬是用來校正視覺的條碼。",
"樹懶不是懶，牠只是活在慢動作濾鏡裡。",

// --- 毫無邏輯的幹話篇 ---
"如果吃比薩不加鳳梨，那我們還能當朋友。",
"你猜猜看，雞跟蛋哪一個先出來？答案是... 恐龍！",
"我今天心情好，決定讓重力輕一點點。",
"你有沒有聽過一句話？『神說：要有光』，其實我當時是想開冰箱。",
"不要問我人生的意義，我自己都在找。",
"如果努力有用，那還要運氣幹嘛？",
"我覺得紫色配綠色挺好看的，下次就把天空改成這色。",
"這裡的空氣聞起來像剛出爐的麵包... 喔那是我的午餐。",
"你的運氣就像這格方塊，合著合著就不見了。",
"不要跟我講道理，我是神，我不講理。",
"其實地球是平的... 騙你的，是甜甜圈形狀的。",
"我剛剛好像不小心按到了『隨機滅絕』按鈕... 沒事吧？",
"這回合結束後，我們去吃火鍋吧。",
"為什麼沒有獨角獸？因為牠們搭不上諾亞方舟。",
"我創造了萬物，但我還是不知道遙控器去哪了。",
"你看那個方塊，它好像在對你笑，笑得你心裡發寒。",
"人生就像 2048，擠一擠總會有空間的。",
"別氣餒，至少你長得比那個單細胞好看。",
"我覺得這局有戲！雖然我上一局也這麼說。",
"你知道嗎？只要你尷尬，尷尬的就是別人。",
"如果方塊滿了怎麼辦？那就... 假裝沒看到。",
"我賦予你神聖的權利：再玩一局。",
"這個世界需要英雄，但現在只需要你動動手指。",
"你有沒有覺得背後涼涼的？那是我在嘆氣。",
"其實我不太會算數，1+1 等於多少？",
"這隻生物長得好隨便，應該是星期五下午做的。",
"如果世界末日來了，記得幫我備份存檔。",
"你滑得這麼用力，手指不痛嗎？",
"我好像聽到你在心裡罵我... 沒禮貌！",
"這就是所謂的『神之手』嗎？還差得遠呢！",
"不要再滑手機了... 好吧，這遊戲例外。",
"我把『快樂』藏在某個方塊裡了，你找得到嗎？",
"其實我有點懼高，所以我不敢往下看人間。",
"你今天的幸運色是... 綠色，跟那個原蟲一樣。",
"保持微笑，就算快輸了也要笑得很優雅。",
"我剛剛是不是打了個瞌睡？錯過什麼精彩畫面了嗎？",
"你知道為什麼海是藍的嗎？因為魚會布魯布魯。",
"加油！你是最棒的... 之一。"
        ],
        waiting: [
    ...
    const godSkillQuotes = {
        undo: ["後悔藥好吃嗎？", "時間倒流...作弊！", "好啦，再給你一次機會", "時光機啟動！", "這是最後一次喔"],
        wave: ["洗香香囉！", "沖走不開心的事~", "咕嚕咕嚕...", "大浪來襲！", "海邊派對開始！"],
        volcano: ["烤肉派對開始！", "這就是熱情！", "蹦！世界清靜了", "岩漿來囉～", "太燙了嗎？"],
        lightning: ["天打雷劈！", "精準打擊", "看誰運氣不好", "索爾是你？", "滋滋滋..."],
    ...
    const godNewCreatureQuotes = {
        ...
        1024: "他們學會用火了！", 2048: "是你ㄟ", 4096: "腦袋變大了，智商up！",
